...
abstract final class UiCopyAbCatalog {
  ...
  static const Map<UiCopyAbProfile, UiCopyAbSet> sets = {
    UiCopyAbProfile.stable: UiCopyAbSet(
      ...
      holdingSuggestionTitle: '천천히 내려두는 쪽이 맞을 때가 있어요',
      holdingSuggestionDescription: '지금은 부담이 줄어드는 타이밍이라, 잠깐 쉬어두는 것으로 정리해도 괜찮아요.',
    ...
    UiCopyAbProfile.gentle: UiCopyAbSet(
      ...
      dropCancel: '지금은 둘게요',
      restoreDefer: '조금 뒤로 미루기',
      holdingSuggestionTitle: '지금은 잠깐 내려두는 게 어때요',
      holdingSuggestionDescription: '눈에 덜 부담스러운 시점이라 보관함에 잠깐 두고 필요할 때 천천히 꺼내도 돼요.',
    ...
    UiCopyAbProfile.playful: UiCopyAbSet(
      ...
      holdingSuggestionTitle: '지금은 잠깐 멈춰두어도 괜찮은 구간이에요',
      holdingSuggestionDescription: '한 번 숨 돌리기 좋은 타이밍으로, 보관함에 차분히 둘 수 있어요.',
